...
const Navbar = () => {
  ...
  return (
    <nav className="fixed right-[10vw] top-4 z-50 w-[92%] max-w-6xl mx-auto bg-white/95 backdrop-blur-md rounded-full px-6 py-4 flex items-center justify-between shadow-md">
      ...
      <div className="flex items-center gap-3">
        <button className="bg-gray-300 hover:bg-gray-400 transition-colors px-5 py-3 rounded-xl font-semibold text-sm cursor-pointer">
          Log in
        </button>
        <button className="bg-gray-900 hover:bg-black transition-colors text-white font-semibold px-5 py-3 rounded-full text-sm cursor-pointer">
          Sign up free
        </button>
      </div>
    </nav>
